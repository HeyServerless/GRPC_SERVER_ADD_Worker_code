...
type PBFTServiceClient interface {
	...
	AddMethod(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error)
}
...
func (c *pBFTServiceClient) AddMethod(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, "/ADD.PBFTService/AddMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PBFTServiceServer interface {
	...
	AddMethod(context.Context, *AddRequest) (*AddResponse, error)
...
func (UnimplementedPBFTServiceServer) AddMethod(context.Context, *AddRequest) (*AddResponse, error) {
...
func _PBFTService_AddMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PBFTServiceServer).AddMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ADD.PBFTService/AddMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PBFTServiceServer).AddMethod(ctx, req.(*AddRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PBFTService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PBFTService_AddMethod_Handler,
		},
	},
